...
package com.garage.settings.preferences;
...
import com.garage.settings.preferences.ShortcutPickHelper;
import com.garage.settings.preferences.ActionPreference;
import com.garage.settings.preferences.CustomActionListAdapter;
...
public class ActionFragment extends SettingsPreferenceFragment implements
    ...
    public int getDialogMetricsCategory(int dialogId) {
        switch (dialogId) {
            case DIALOG_CATEGORY:
            case DIALOG_CUSTOM_ACTIONS:
                return MetricsEvent.GARAGE_SETTINGS;
            default:
                return 0;
        }
    }
