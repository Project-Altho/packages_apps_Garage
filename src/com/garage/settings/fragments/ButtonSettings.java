...
import com.garage.settings.preferences.SecureSettingSwitchPreference;
import com.android.internal.logging.nano.MetricsProto;
import com.android.internal.util.hwkeys.ActionConstants;
import com.android.internal.util.hwkeys.ActionUtils;

import com.garage.settings.preferences.CustomSeekBarPreference;
import com.garage.settings.preferences.ActionFragment;
...
public class ButtonSettings extends ActionFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.garage_button);
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.garage_button;
                    result.add(sir);
                    return result;
                }
